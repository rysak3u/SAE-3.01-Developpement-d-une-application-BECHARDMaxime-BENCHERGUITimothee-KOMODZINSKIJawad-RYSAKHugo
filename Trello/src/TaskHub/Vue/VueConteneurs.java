...
public class VueConteneurs extends VBox implements Observateur {
    ...
    public void actualiser(Sujet o) {
        ...
        for(Conteneur colonne : this.modele.getTableau().getConteneurs()){
            ...
            button.addEventHandler(MouseEvent.MOUSE_CLICKED,new ControllerAfficherFormulaire(this.modele,this.modele.getTableau().getConteneurs().indexOf(colonne)));
